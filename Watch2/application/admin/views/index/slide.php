...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">	
        ...
        <table class="table table-bordered table-responsive table-hover text-center">
            ...
            <tr>
                ...
                <td>
                    <img src="<?php echo URL_BASE;?>templates/admin/uploads/<?php echo $anh; ?>" style="width: 100%">
                </td>
                <td>                    
                    <a href="update.php?id=<?php echo $slide_id;?>" class="btn btn-xs  btn-primary">Sửa</a>
                    <?php  
